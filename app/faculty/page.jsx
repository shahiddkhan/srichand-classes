...
const FACULTY = [
  {
    ...
    achievements: [
      ...
      'Generations of students mentored',
      'Commanding classroom presence & enigmatic style',
    ],
  },
  {
    id: 'vinesh',
    ...
    achievements: [
      ...
      'Blends humour with academic rigour',
      'Makes complex Science relatable and enjoyable',
    ],
  },
  {
    id: 'sandeep',
    ...
    achievements: [
      ...
      'Infectious energy and signature sense of humour',
      'Students develop deep appreciation for Geometry',
    ],
  },
  {
    id: 'harsh',
    ...
    achievements: [
      ...
      'Former Equity Research Analyst at TresVista',
      'Patient, structured, concept-driven approach',
    ],
  },
  {
    id: 'kunal',
    ...
    achievements: [
      ...
      'Young, relatable and deeply respected mentor',
    ],
  },
  {
    id: 'vidhi',
    ...
    achievements: [
      ...
      'Structured, clarity-first teaching methodology',
      'Students consistently achieve excellent results',
    ],
  },
]

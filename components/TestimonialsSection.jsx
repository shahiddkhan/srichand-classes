      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12">
          ...
          <div className="inline-flex items-center gap-3 bg-white border border-slate-200 rounded-2xl px-6 py-3 mt-5 shadow-card">
            <span className="font-heading font-black text-4xl text-primary">4.8</span>
            <div>
          ...
          {TESTIMONIALS.map(t => (
            <div key={t.name} className="card p-6 flex flex-col">
              ...
              <div className="mt-5 pt-4 border-t border-slate-100 flex items-center justify-between">
                ...
                <div className="w-8 h-8 rounded-full bg-brand-gradient flex items-center justify-center text-white font-heading font-bold text-sm">
                  {t.name[0]}
                </div>
              </div>
            </div>

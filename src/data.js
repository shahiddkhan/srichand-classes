...
export const COURSES = [
  {
    ...
    shortDesc: 'Expert coaching across SSC, ICSE and CBSE boards with strong focus on concept clarity and writing practice.',
    fullDesc:
  ...
  },
  {
    ...
    shortDesc: 'Specialised coaching for Commerce students preparing for HSC board exams with subject experts.',
    fullDesc:
  ...
  },
  {
    ...
    shortDesc: 'University-level coaching for Commerce degree students from Mumbai University affiliated colleges.',
    fullDesc:
...
export const FACULTY = [
  ...
  },
  {
    ...
    bio: 'Vinay Sir handles English language skills and Geography with a focus on writing quality and presentation. His writing practice sessions are popular among students aiming for high scores in language papers across all boards.',
    highlights: [
...
export const BRANCHES = [
  {
    ...
    name: 'Sion',
    tag: 'Main Branch',
    tagClass: 'bg-navy-700 text-white',
    icon: '🏢',
    since: 'Est. 1958',
...
export const TESTIMONIALS = [
  { name: 'Priya Sharma',   cls: 'Class X – SSC',    rating: 5, text: 'Great writing practice sessions. My board scores improved significantly after joining Srichand Classes.' },
  { name: 'Rohan Mehta',   cls: 'XII Commerce',      rating: 5, text: 'Very helpful teachers. Sandeep Sir made Accountancy easy. I secured distinction in HSC.' },
  { name: 'Ananya Nair',   cls: 'Class IX – ICSE',   rating: 5, text: 'Strong exam preparation. The weekly tests really helped me stay on track throughout the year.' },
  { name: 'Vikram Joshi',  cls: 'BCom',              rating: 4, text: 'Excellent degree coaching. The study material and mock papers are very thorough and exam-focused.' },
  { name: 'Shreya Patil',  cls: 'Class X – CBSE',   rating: 5, text: 'The small batch size ensures personal attention. Faculty know every student by name and track progress closely.' },
  { name: 'Aarav Kulkarni',cls: 'XI Commerce',       rating: 5, text: 'Made the shift from SSC to Commerce very smooth. The faculty are patient and explain concepts thoroughly.' },
]
